describe('Verificar se ao clicar no botão com ícone de X, após finalizar uma fase, o usuário será redirecionado para a tela de seleção de fases.', () => {
    it('O usuário deve ser redirecionado corretamente para a tela de seleção de fases.', () => {
