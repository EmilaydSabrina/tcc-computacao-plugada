describe('Verificar se ao clicar no botão com ícone de Seta, após finalizar uma fase, o usuário será redirecionado automaticamente para próxima fase.', () => {
    it('O usuário deve ser redirecionado corretamente para a próxima fase após concluir a fase atual.', () => {
      ...
      cy.get('[href="/level2-1"] > .nav-btn').click('');
      cy.get('strong').should('contain', 'FASE 2')
    })
})